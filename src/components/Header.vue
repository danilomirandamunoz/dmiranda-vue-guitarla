...
defineEmits(['disminuir-cantidad-carrito', 'aumentar-cantidad-carrito', 'eliminar-producto-carrito','agregar-carrito', 'vaciar-carrito'])
                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                                    ...
                                    <tr v-for="producto in carrito">
                                        ...
                                        <td class="flex align-items-start gap-4">
                                            <button
                                                type="button"
                                                class="btn btn-dark"
                                                @click="$emit('disminuir-cantidad-carrito', producto.id)"
                                            ...
                                            <button
                                                type="button"
                                                class="btn btn-dark"
                                                @click="$emit('aumentar-cantidad-carrito', producto.id)"
                                            >
                                                +
                                            </button>
                                        </td>
                            ...
                            <p class="text-end" v-if="carrito?.length>0">Total pagar: <span class="fw-bold">${{ totalCarrito }}</span></p>
